...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_NUM = 41,                       /* NUM  */
  YYSYMBOL_ID = 42,                        /* ID  */
  YYSYMBOL_CHARC = 43,                     /* CHARC  */
  YYSYMBOL_YYACCEPT = 44,                  /* $accept  */
  YYSYMBOL_program = 45,                   /* program  */
  YYSYMBOL_programHead = 46,               /* programHead  */
  YYSYMBOL_programBody = 47                /* programBody  */
};
...
static const char *const yytname[] =
{
  ...
  "SEMI", "COMMA", "RANGE", "ERROR", "NUM", "ID", "CHARC", "$accept",
  "program", "programHead", "programBody", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* program: programHead programBody DOT  */
#line 39 "snl.y"
              {
                  (yyval.node) = new TreeNode(); // 创建根节点
                  (yyval.node)->nodekind = ProgramK;
                  (yyval.node)->child[0] = (yyvsp[-2].node);   // 挂上程序头
                  (yyval.node)->child[1] = (yyvsp[-1].node);   // 挂上程序体
                  root = (yyval.node);           // 记录下这棵大树的根
              }
#line 1124 "snl.tab.c"
    break;
...
#line 49 "snl.y"
              {
                  ...
                  (yyval.node)->nodekind = RoutineK; // 暂作常规节点标记
                  (yyval.node)->attr.name = (yyvsp[-1].name);      // 记录下程序名字
              }
#line 1134 "snl.tab.c"
    break;

  case 4: /* programBody: BEGIN_SYM END  */
#line 57 "snl.y"
              {
                  (yyval.node) = NULL; 
              }
...
// 遇到语法错误时 Bison 会调用这个函数
void yyerror(const char *s) {
    cerr << "Syntax Error at line " << lineno << ": " << s << endl;
}
